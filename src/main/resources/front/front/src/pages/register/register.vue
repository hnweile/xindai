	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于Hadoop的信贷风险评估的数据可视化分析与预测系统的设计与实现</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='fengkongzhuanyuan'" prop="zhuanyuanzhanghao">
						<div class="label" :class="changeRules('zhuanyuanzhanghao')?'required':''">专员账号：</div>
						<el-input v-model="registerForm.zhuanyuanzhanghao"  placeholder="请输入专员账号" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='fengkongzhuanyuan'" prop="mima">
						<div class="label" :class="changeRules('mima')?'required':''">密码：</div>
						<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='fengkongzhuanyuan'" prop="mima2">
						<div class="label" :class="changeRules('mima')?'required':''">确认密码：</div>
						<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='fengkongzhuanyuan'" prop="zhuanyuanxingming">
						<div class="label" :class="changeRules('zhuanyuanxingming')?'required':''">专员姓名：</div>
						<el-input v-model="registerForm.zhuanyuanxingming"  placeholder="请输入专员姓名" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='fengkongzhuanyuan'" prop="xingbie">
						<div class="label" :class="changeRules('xingbie')?'required':''">性别：</div>
						<el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
							<el-option
					...
					<el-form-item class="list-item" v-if="tableName=='fengkongzhuanyuan'" prop="lianxidianhua">
					...
					<el-form-item class="list-item" v-if="tableName=='fengkongzhuanyuan'" prop="touxiang">
						<div class="label" :class="changeRules('touxiang')?'required':''">头像：</div>
						<file-upload
							tip="点击上传头像"
							action="file/upload"
	...
	mounted() {
		if(this.$route.query.pageFlag=='register'){
			...
			if ('fengkongzhuanyuan' == this.tableName) {
				...
				this.requiredRules.zhuanyuanzhanghao = [{ required: true, message: '请输入专员账号', trigger: 'blur' }]
			}
			if ('fengkongzhuanyuan' == this.tableName) {
				this.rules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }];
				this.requiredRules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }]
			...
			if ('fengkongzhuanyuan' == this.tableName) {
				...
				this.requiredRules.zhuanyuanxingming = [{ required: true, message: '请输入专员姓名', trigger: 'blur' }]
			}
		...
		submitForm(formName) {
			this.$refs[formName].validate((valid) => {
				if (valid) {
					...
					if(`fengkongzhuanyuan` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
						this.$message.error(`两次密码输入不一致`);
						return
					}
